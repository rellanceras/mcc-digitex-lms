...
<div class="block_md block_primary" id="page-header">
    <div class="px-4 pt-4">
        ...
        <h6 class="mb-3">Current Academic year: <span class="fw-bold currentActive">2023-2024</span></h6>
    </div>
    <nav class="block_md block_secondary">
        <ol class="breadcrumb px-4 py-2 m-0">
            <li class="breadcrumb-item"><a class="text-decoration-none breadcrumbActive" href="#">A.Y. 2023-2024</a></li>
