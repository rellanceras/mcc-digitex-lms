...
<!-- Mobile Navigation -->
<div class="d-md-none d-flex justify-content-between px-3 py-2 m-2 block_md block_primary">

    <!-- Button for showing sidebar (mobile) -->
    <button class="btn block_md nav_select navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#sidebar_mobile">
    ...
    <!-- Sidebar (mobile) -->
    <div class="offcanvas offcanvas-start m-3 block_md block_primary" tabindex="-1" id="sidebar_mobile">
        ...
        <div class="offcanvas-body">
            <ul class="d-flex flex-column list-unstyled gap-3">
                ...
                <hr />
                <li class="nav-item block_sm main_link link_dashboard nav_select" data-bs-dismiss="offcanvas">
                ...
                <li class="nav-item block_sm main_link link_class nav_select" data-bs-dismiss="offcanvas">
                ...
                <li class="nav-item block_sm main_link link_users nav_select" data-bs-dismiss="offcanvas">
                ...
                <li class="nav-item block_sm main_link link_calendar nav_select" data-bs-dismiss="offcanvas">
                ...
                <li class="nav-item block_sm main_link link_settings nav_select" data-bs-dismiss="offcanvas">
                ...
                <hr />
                <li class="nav-item block_sm nav_select sb_link" data-bs-dismiss="offcanvas">
                    <a class="nav-link text-reset" href="#" href="../index.php">
                        <div class="d-flex align-items-center">
...
<div class="d-flex gap-3 min-vh-100 p-2">
    ...
    <div class="d-none d-md-block p-3 block_md block_primary" id="sidebar_desktop">
        <ul class="d-flex flex-column gap-3 list-unstyled">
            ...
            <li class="nav-item block_sm main_link link_users nav_select tool_tip" data-bs-toggle="tooltip" data-bs-placement="right" title="Users">
                <a class="nav-link text-reset" href="#" data-page="users">
                    <div class="d-flex align-items-center justify-content-center gap-3 nav_link">
                        <span class="material-icons">manage_accounts</span>
