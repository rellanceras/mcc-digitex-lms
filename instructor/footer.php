...
function load_jsonMainPage(page, data) {
    switch(page) {
        case "qbank" :
            $("#mainContent").load(data.qbank["index"]);
            $(".link_qbank").addClass("nav_active");
            $(".link_qbank").removeClass("nav_select");
            document.title = "Question Bank | Digitex LMS";
            break;
        case "class" :
            ...
            break;
        case "grades" :
            $("#mainContent").load(data.grades["index"]);
            $(".link_grades").addClass("nav_active");
            $(".link_grades").removeClass("nav_select");
            document.title = "Grades | Digitex LMS";
            break;
        case "settings" :
