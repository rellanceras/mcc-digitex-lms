...
$(document).ready(function() {
    $("#add_multi").click(function(){
        var multi_format = `<div class="input-group">
                            <input class="form-control" name=""/>
                            <button class="btn btn-danger del_multi">X</button>
                        </div>`;
        $("#choices").append(multi_format);
    });

    $('#choices').on('click', '.del_multi', function() {
        $(this).closest(".input-group").remove();
    });

    $(".see").click(function() {
        $(this).siblings(".td_limit").toggleClass("td_limit_height");
