...
<div class="container p-0">
    ...
    <div class="d-flex flex-column min-vh-100 gap-3 p-3">
        <div class="d-flex align-items-center justify-content-between sticky-top block_md block_primary px-3 py-2" id="topnav">
        ...
        <hr/>
        <div class="d-flex flex-column gap-3 block_md block_primary p-3">
            <div class="block_md block_secondary p-3" id="q1">
            ...
            <div class="block_md block_secondary p-3" id="q2">
                <div class="d-flex justify-content-between">
            ...
            <div class="block_md block_secondary p-3" id="q3">
                <div class="d-flex justify-content-between">
            ...
            <div class="block_md block_secondary p-3" id="q4">
                <div class="d-flex justify-content-between">
